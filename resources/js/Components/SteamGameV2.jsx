...
export default function SteamGameV2({ steamgame }) {
    ...
    return(
        <div className="flex items-center">
            ...
            <div className="top-0 m-4">
                {/* title panel */}
                <span className="text-4xl text-gray-800 font-black">{steamgame.name}</span>   
            </div>
            <div className=''>
                {/* numerics panel */}
                <div className="border grid grid-rows-3 grid-cols-2 w-60">
                ...
                <div className="grid grid-rows-3 grid-cols-2 border w-60">
